...
const{problem_statement,solution,tech_stack}=content;
const{live_demo,code_preview}=button;

export function setProjectContent(){
    $("#projects-section h3").text(title);
    $("#projects-section #problem-statement").text(problem_statement);
    $("#projects-section #solution").text(solution);
    $("#projects-section #tech-stack").text(tech_stack);
